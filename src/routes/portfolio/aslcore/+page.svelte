...
<section>
	...
	<p>
		...
		ASLCORE from November 2016 to the end of 2019, and over the course of this time, I functioned as
		both the designer and developer of the project, designing the interface and graphical materials,
		as well as coding and maintaining a custom front- and backend to allow for the scaling the
		project would need.
	</p>
	<p>
		...
		site. Our set-ups began relatively basic, with me bringing in some of my own lighting equipment
		and using my own camera. As the project grew, DAS supplied us with high quality cameras,
		lighting, and dedicated studio space, which drastically increased the production value we were
		able to output.
	</p>
	<p>
